...
public class TileTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("f1.getAbsolutePath : " + f1.getAbsolutePath()); //절대경로
			System.out.println("f2.getAbsolutePath : " + f2.getAbsolutePath()); //절대경로
			System.out.println("f1.getPath : " + f1.getPath()); // 상대경로
			System.out.println("f2.getPath : " + f2.getPath()); // 상대경로
