 ...
 * 	
 *  상속(Inheritance)
 *  - 기존 클래스의 속성과 기능을 그대로 자식클래스에 확장 시키는 프로그래밍 문법
 *  - 공통적인 로직 내용을 부모클래스에 두고 자식 클래스에서 상속받아 일관된 프로그래밍을 수행
 *  - 부모클래스의 속성 접근 권한을 protected로 변경하고 자식클래스에서는 부모 속성을 초기화
 */
...
public class InheritTest {
	public static void main(String[] args) {
		...
		int rs1 = c1.plus();	//부모 클래스에 있는 메서드 사용
		int rs2 = c1.minus();
